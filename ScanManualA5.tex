...
\chapter{Estructura del proyecto de \abbyy 14\label{sec:abbyyProjectStructure}} En la figura~\ref{fig:abbyyProjectStructure} se presenta un diagrama del árbol de directorios que se genera cuando guardamos un proyecto de \abbyy~v14.
...
\begin{itemize}
	...
	\item archivos ocultos en estructura de \abbyy.
